...
def train():
        ...
        res=model.fit_generator(driving_data.generator(driving_data.train_xs,driving_data.train_ys,112), validation_data = (X, y), samples_per_epoch = 400*112 , nb_epoch=epochs, verbose = 1  ,callbacks = [ checkpoint ])
